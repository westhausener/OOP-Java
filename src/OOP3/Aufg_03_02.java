...
public class Aufg_03_02 {
	...
	public static void main(String[] args) {
	    ...
	    Kuh[] Nachmittagsstall = new Kuh[3];
	    
	    Nachmittagsstall[0] = new Kuh();
	    Nachmittagsstall[1] = new Kuh();
	    Nachmittagsstall[2] = new Kuh();
	    
	    Nachmittagsstall[1].geburtsdatum = "23.1.2022";
	    Nachmittagsstall[2].gewicht = 100;
